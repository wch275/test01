...
u"""
Borni DHIFI : modifier le script pour supporter 3  décimaux .
"""
...
def trad(nb,unite=UNITE, decim=DECIM):
    global t1, t2
    #nb = round(nb, 2)
...
def tradV(nb,unite,decim):
    global t1, t2
    #nb = round(nb, 2)
    t1 = ["", "Un", "Deux", "Trois", "Quatre", "Cinq", "Six", "Sept", "Huit", "Neuf", "Dix", "Onze", "Douze", "Treize", "Quatorze", "Quinze", "Seize", "Dix-sept", "Dix-huit", "dix-neuf"]
    t2 = ["", "Dix", "Vingt", "Trente", "Quarante", "Cinquante", "Soixante", "Soixante-dix", "Quatre-vingt", "Quatre-vingt Dix"]
    z1 = int(nb)
    #deux chiffre aprés virgule EURO
    z3 = (nb - z1) * 100
    z2 = int(round(z3, 0))
    if z1 == 0:
        ch = u"zéro"
