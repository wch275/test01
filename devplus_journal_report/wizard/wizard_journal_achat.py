...
class wizard_journal_achat(osv.osv_memory):
    _name = "wizard.journal.achat"
    _description = "Journal Achat"
    ...
    def _print_report(self, cr, uid, ids, data, context=None):
        ...
        return self.pool['report'].get_action(cr, uid, [], 'devplus_journal_report.report_journal_achat', data=data, context=context)
