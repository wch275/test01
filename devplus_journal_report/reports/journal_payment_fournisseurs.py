...
class journal_payment_fournisseurs_report(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        super(journal_payment_fournisseurs_report, self).__init__(cr, uid, name, context=context)
...
class report_journal_payment_fournisseurs(osv.AbstractModel):
    _name = 'report.devplus_journal_report.journal_payment_fournisseurs_report'
    _inherit = 'report.abstract_report'
    _template = 'devplus_journal_report.journal_payment_fournisseurs_report'
    _wrapped_report_class = journal_payment_fournisseurs_report  